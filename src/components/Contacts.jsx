...
const Contacts = () => {
  return (
    <>
      <div data-aos="flip-left" data-aos-duration="700"  className='bg-gradient-to-r from-red-50'>
        {/* Heading */}
        ...
        <div className="bg-gradient-to-r from-red-50 flex flex-col lg:flex-row justify-center items-center gap-8 px-4 sm:px-6 lg:px-12 py-6 bg-white text-gray-800">
          ...
          {/* Form Card */}
          <div className="w-full max-w-sm sm:max-w-md lg:max-w-md xl:max-w-lg">
            <SignInCard />
          </div>

          {/* Contact Info Card */}
          <div className="w-full max-w-sm sm:max-w-md lg:max-w-md xl:max-w-xl">
